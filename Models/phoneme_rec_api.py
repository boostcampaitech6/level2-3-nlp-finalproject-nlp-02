...
processor = Wav2Vec2Processor.from_pretrained(
    "facebook/wav2vec2-lv-60-espeak-cv-ft", cache_dir="/dev/shm/phoneme/lv"
)
...
async def upload_wav_and_json(
    wav_file: Annotated[UploadFile, File()], text: Annotated[str, Form()]
):
    try:
        ...
        wtp = processor.batch_decode(
            predicted_ids, skip_special_tokens=True, output_char_offsets=True
        )
