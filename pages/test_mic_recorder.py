...
def callback():
    ...
    # Check if 'my_recorder_output' exists in st.session_state
    if 'my_recorder_output' in st.session_state and st.session_state.my_recorder_output is not None:
        audio_data = st.session_state.my_recorder_output['bytes']  # .get method is used to prevent exceptions
