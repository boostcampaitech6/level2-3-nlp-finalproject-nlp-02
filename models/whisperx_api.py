...
model = whisperx.load_model("large-v3", "cuda", language='en', compute_type="float16" ,download_root='/dev/shm/whisperx')
...
async def predict(file: UploadFile = File(...)):
    try:
        ...
        result1 = whisperx.align(result["segments"], model_a, metadata, audio, device="cuda", return_char_alignments=False)
        ls = []
