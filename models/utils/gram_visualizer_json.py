...
if __name__ == "__main__":
    ...
    with open(os.path.join(gector_path, "input", "macominatya.json"), "w", encoding="utf-8") as jf:
    ...
    # get all sentences
    with open(os.path.join(gector_path, "input", "macominatya.json"), "r", encoding="utf-8") as jf:
        data = json.load(jf)
